# fork from https://github.com/bowofade/Final-Project
...
class ConsoleInput:
    ...
    def get_new_customer() -> Customer:
        ...
        print("- COUNTRY -")
        is_USA = input("If you are ordering from Canada please type \"YES\" now: ")
        if is_USA.strip().upper() in ["YES","Y", "YA"]:
            ConsoleInput.country = "USA"
        ...
        if ConsoleInput.country == "US":
            ...
            print("NGERIA ADDRESS EXAMPLE: 100 Wellington St, YABA, LAGOS, 10010")
