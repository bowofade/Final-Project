...
class Address(object):
    ...
    The Address object describes a street address in North America. Callers can use the Address object's methods to find
    ...
    def nearby_stores(self, service='Delivery'):
        ...
        """
        data = request_pizzapy(self.urls.find_url(), line1=self.line1, line2=self.line2, type=service)
